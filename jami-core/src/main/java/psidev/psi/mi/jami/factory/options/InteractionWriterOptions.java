...
public class InteractionWriterOptions {
     ...
     * It must be a String.
     * This option must always be provided to the {@link psidev.psi.mi.jami.factory.InteractionWriterFactory} to select the adapted writer implementation
     ...
     * so only binary interactions are written. When COMPLEX_TYPE_OPTION_KEY is binary,
