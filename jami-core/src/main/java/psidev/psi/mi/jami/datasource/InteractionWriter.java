...
public interface InteractionWriter<T extends Interaction> {
     ...
     *
     * @throws psidev.psi.mi.jami.exception.MIIOException : if cannot end
     */
     ...
     *
     * @throws psidev.psi.mi.jami.exception.MIIOException : if cannot flush
     */
     ...
     *
     * @throws psidev.psi.mi.jami.exception.MIIOException : if cannot close
     */
