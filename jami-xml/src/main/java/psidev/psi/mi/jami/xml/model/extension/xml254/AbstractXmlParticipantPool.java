...
public abstract class AbstractXmlParticipantPool<I extends Interaction, F extends Feature, P extends ParticipantCandidate>
        implements ParticipantPool<I,F,P>, EntityInteractorChangeListener, FileSourceContext, ExtendedPsiXmlEntity<F>, psidev.psi.mi.jami.model.NamedParticipant<I, F> {
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml254.AbstractXmlParticipant} object.
     */
