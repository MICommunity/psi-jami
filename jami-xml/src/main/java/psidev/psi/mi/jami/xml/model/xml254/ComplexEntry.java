...
public class ComplexEntry extends AbstractEntry<Complex> {
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.xml254.ComplexEntry.JAXBExperimentsWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.xml254.ComplexEntry.JAXBInteractionsWrapper} object.
     */
    ...
    //////////////////////////////// class wrapper
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="complexExperimentsWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="complexInteractionsWrapper")
    public static class JAXBInteractionsWrapper extends AbstractEntry.JAXBInteractionsWrapper<Complex>{
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= DefaultXmlComplex.class, name="interaction", required = true)
