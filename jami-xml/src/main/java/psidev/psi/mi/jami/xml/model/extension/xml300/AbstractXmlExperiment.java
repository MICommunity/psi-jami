...
public abstract class AbstractXmlExperiment implements ExtendedPsiXmlExperiment, FileSourceContext, Locatable{
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml300.NamesContainer} object.
     */
     ...
     * @param value
     *     allowed object is
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml300.NamesContainer}
     */
     ...
     * @param value
     *     allowed object is
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml300.XrefContainer}
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlExperiment.JAXBHostOrganismWrapper} object.
     */
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="interactionDetectionMethod", required = true)
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="participantIdentificationMethod", type = XmlCvTerm.class)
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="featureDetectionMethod", type = XmlCvTerm.class)
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlExperiment.JAXBConfidenceWrapper} object.
     */
     ...
     *
     * @param jaxbVariableParameterList a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlExperiment.JAXBVariableParameterWrapper} object.
     */
    ...
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="variableParameterList")
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlExperiment.JAXBAttributeWrapper} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="experimentAttributeWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="experimentOrganismWrapper")
    public static class JAXBHostOrganismWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", type= XmlOrganism.class, name="hostOrganism", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="experimentConfidenceWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="variableParametersWrapper")
    public static class JAXBVariableParameterWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", type= XmlVariableParameter.class, name="variableParameter", required = true)
