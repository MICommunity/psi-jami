...
public class XmlModelledParticipant extends AbstractXmlParticipant<ModelledInteraction, ModelledFeature> implements ModelledParticipant {
    ...
    ////////////////////////////////////////////////////// classes
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="modelledParticipantFeatureWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="modelledParticipantInteractorCandidateWrapper")
    public static class JAXBInteractorCandidatesWrapper extends
        ...
        @Override
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="interactorCandidate", type = XmlModelledParticipantCandidate.class)
