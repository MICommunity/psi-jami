...
public abstract class AbstractXmlExperiment implements ExtendedPsiXmlExperiment, FileSourceContext, Locatable{
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="participantIdentificationMethod", type = XmlCvTerm.class)
    ...
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="variableParameterList")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="experimentAttributeWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="experimentOrganismWrapper")
    public static class JAXBHostOrganismWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= XmlOrganism.class, name="hostOrganism", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="experimentConfidenceWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="variableParametersWrapper")
    public static class JAXBVariableParameterWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= XmlVariableParameter.class, name="variableParameter", required = true)
