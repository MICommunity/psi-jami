 ...
 */
public abstract class AbstractExpandedXmlComplexWriter extends AbstractExpandedXmlWriter<Complex> {

    /**
     * <p>Constructor for ExpandedXmlComplexWriter.</p>
     */
    public AbstractExpandedXmlComplexWriter() {
        super(Complex.class);
    }
     ...
     */
    public AbstractExpandedXmlComplexWriter(File file) throws IOException, XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractExpandedXmlComplexWriter(OutputStream output) throws XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractExpandedXmlComplexWriter(Writer writer) throws XMLStreamException {
     ...
     */
    public AbstractExpandedXmlComplexWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
