...
public class BasicEntry extends AbstractEntry<Interaction> {
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.xml254.BasicEntry.JAXBInteractionsWrapper} object.
     */
    ...
    public static class JAXBInteractionsWrapper extends AbstractEntry.JAXBInteractionsWrapper<Interaction>{
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= DefaultXmlBasicInteraction.class, name="interaction", required = true)
