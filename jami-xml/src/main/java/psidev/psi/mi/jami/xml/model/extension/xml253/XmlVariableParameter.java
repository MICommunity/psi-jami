...
public class XmlVariableParameter implements VariableParameter,FileSourceContext,Locatable {
     ...
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name = "description", required = true)
     ...
     * <p>setJAXBUnit.</p>
     *
     * @param unit a {@link psidev.psi.mi.jami.xml.model.extension.xml253.XmlCvTerm} object.
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name = "unit")
     ...
     *
     * @param jaxbVariableValueList a {@link psidev.psi.mi.jami.xml.model.extension.xml253.XmlVariableParameter.JAXBVariableValueWrapper} object.
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name = "variableValueList", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="variableValuesWrapper")
    public static class JAXBVariableValueWrapper implements Locatable, FileSourceContext{
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type=XmlVariableParameterValue.class, name="variableValue", required = true)
