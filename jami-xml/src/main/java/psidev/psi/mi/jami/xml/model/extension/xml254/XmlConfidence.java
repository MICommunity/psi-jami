...
public class XmlConfidence extends AbstractXmlConfidence {
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlConfidence.JAXBExperimentRefWrapper} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name = "confidenceExperimentRefList")
