...
import psidev.psi.mi.jami.xml.model.extension.xml300.DefaultXmlModelledInteraction;
...
public class ModelledEntry extends AbstractEntry<ModelledInteraction> {
    ...
    //////////////////////////////// class wrapper
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="modelledExperimentsWrapper")
    ...
    public static class JAXBInteractionsWrapper extends AbstractEntry.JAXBInteractionsWrapper<ModelledInteraction>{
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", type= DefaultXmlModelledInteraction.class, name="interaction", required = true)
