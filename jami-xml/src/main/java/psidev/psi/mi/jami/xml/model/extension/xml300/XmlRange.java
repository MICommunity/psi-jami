...
public class XmlRange implements Range, FileSourceContext, Locatable {
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="startStatus", required = true)
     ...
     * @param value
     *     allowed object is
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlInterval}
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="beginInterval")
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="begin")
     ...
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlCvTerm}
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="endStatus", required = true)
     ...
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlInterval}
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="endInterval")
     ...
     * @param value
     *     allowed object is
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlPosition}
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="end")
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="isLink", defaultValue = "false")
     ...
     *
     * @param resultingSequence a {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlResultingSequence} object.
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="resultingSequence")
