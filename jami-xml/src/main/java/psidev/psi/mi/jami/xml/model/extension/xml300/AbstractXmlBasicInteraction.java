...
public abstract class AbstractXmlBasicInteraction extends AbstractPsiXmlInteraction<Participant> {
     ...
     *
     * @param jaxbParticipantWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlBasicInteraction.JAXBParticipantWrapper} object.
     */
    ...
    ////////////////////////////////////////////////////// classes
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="basicParticipantWrapper")
    public static class JAXBParticipantWrapper extends AbstractPsiXmlInteraction.JAXBParticipantWrapper<Participant> {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", type= XmlParticipant.class, name="participant", required = true)
