...
import psidev.psi.mi.jami.xml.model.reference.xml254.AbstractAvailabilityRef;
...
public abstract class AbstractXmlInteractionEvidence extends AbstractPsiXmlInteraction<ParticipantEvidence> implements ExtendedPsiXmlInteractionEvidence {
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name = "participantEvidenceWrapper")
    public static class JAXBParticipantWrapper extends AbstractPsiXmlInteraction.JAXBParticipantWrapper<ParticipantEvidence> {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type = XmlParticipantEvidence.class, name = "participant", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name = "experimentalConfidenceWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name = "experimentalParameterWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name = "experimentListType")
    public static class JAXBExperimentWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="experimentDescription", required = true, type = DefaultXmlExperiment.class)
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="experimentRef", required = true, type = Integer.class)
