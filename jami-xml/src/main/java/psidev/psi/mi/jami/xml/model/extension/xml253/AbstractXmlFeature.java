...
public abstract class AbstractXmlFeature<P extends Entity, F extends Feature> implements
    ...
    @XmlType(namespace = "net:sf:psidev:mi", name="featureAttributeWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="featureRangeWrapper")
    public static class JAXBRangeWrapper implements Locatable, FileSourceContext{
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type=XmlRange.class, name="featureRange", required = true)
