...
public class XmlFeatureEvidence extends AbstractXmlFeature<ExperimentalEntity, FeatureEvidence> implements ExtendedPsiXmlFeatureEvidence {
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlFeatureEvidence.JAXBExperimentRefWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlFeatureEvidence.JAXBParameterWrapper} object.
     */
    ...
    protected void initialiseDetectionMethods(){
        ...
        if (originalParticipant != null){
            psidev.psi.mi.jami.xml.model.extension.ExtendedPsiXmlInteractionEvidence interaction = originalParticipant.getOriginalInteraction();
            if (interaction != null){
     ...
     *
     * @param p a {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlParticipantEvidence} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name = "featureExperimentRefList")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="featureParameterWrapper")
