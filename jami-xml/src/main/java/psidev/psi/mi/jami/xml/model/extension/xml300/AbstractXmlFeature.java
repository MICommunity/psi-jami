...
public abstract class AbstractXmlFeature<P extends Entity, F extends Feature> implements
     ...
     * @param value
     *     allowed object is
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml300.FeatureXrefContainer}
     */
     ...
     *
     * @param jaxbAttributeWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlFeature.JAXBAttributeWrapper} object.
     */
     ...
     *
     * @param jaxbRangeWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlFeature.JAXBRangeWrapper} object.
     */
     ...
     *
     * @param role a {@link psidev.psi.mi.jami.xml.model.extension.xml300.XmlCvTerm} object.
     */
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlFeature.JAXBRangeWrapper} object.
     */
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlFeature.JAXBAttributeWrapper} object.
     */
    ...
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="featureAttributeWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="featureRangeWrapper")
    public static class JAXBRangeWrapper implements Locatable, FileSourceContext{
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", type= XmlRange.class, name="featureRange", required = true)
