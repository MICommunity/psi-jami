...
public abstract class AbstractXmlSource extends AbstractXmlCvTerm implements ExtendedPsiXmlSource
{
     ...
     * <p>setJAXBBibRef.</p>
     *
     * @param ref a {@link psidev.psi.mi.jami.xml.model.extension.xml254.BibRef} object.
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name = "bibref", type = BibRef.class)
    ...
    @XmlSchemaType(namespace = "http://psi.hupo.org/mi/mif", name = "date")
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.AbstractXmlSource.JAXBAttributeWrapper} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="sourceAnnotationWrapper")
