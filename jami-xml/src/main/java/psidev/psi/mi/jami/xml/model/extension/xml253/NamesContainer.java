...
public class NamesContainer extends AbstractNamesContainer {
     ...
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name = "shortLabel")
     ...
     *     {@link java.lang.String}
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name = "fullName")
     ...
     */
    @XmlElement(namespace = "net:sf:psidev:mi", type= XmlAlias.class, name = "alias")
