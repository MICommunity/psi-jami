...
public abstract class AbstractXmlModelledInteraction extends AbstractPsiXmlInteraction<ModelledParticipant> implements psidev.psi.mi.jami.xml.model.extension.ExtendedPsiXmlModelledInteraction {
     ...
     *
     * @param jaxbParticipantWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlModelledInteraction.JAXBParticipantWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlModelledInteraction.JAXBConfidenceWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlModelledInteraction.JAXBParameterWrapper} object.
     */
     ...
     *
     * @param value a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlModelledInteraction.JAXBExperimentWrapper} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name="modelledConfidenceWrapper")
    public static class JAXBConfidenceWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", type= XmlModelledConfidence.class, name="confidence", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name = "modelledExperimentListType")
