 ...
 */
public abstract class AbstractLightExpandedXmlBinaryWriter extends AbstractExpandedXmlWriter<BinaryInteraction> {

    /**
     * <p>Constructor for LightExpandedXmlBinaryWriter.</p>
     */
    public AbstractLightExpandedXmlBinaryWriter() {
     ...
     */
    public AbstractLightExpandedXmlBinaryWriter(File file) throws IOException, XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractLightExpandedXmlBinaryWriter(OutputStream output) throws XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractLightExpandedXmlBinaryWriter(Writer writer) throws XMLStreamException {
     ...
     */
    public AbstractLightExpandedXmlBinaryWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
