...
import psidev.psi.mi.jami.xml.model.reference.xml253.AbstractAvailabilityRef;
...
public abstract class AbstractXmlInteractionEvidence extends AbstractPsiXmlInteraction<ParticipantEvidence> implements ExtendedPsiXmlInteractionEvidence {
     ...
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name ="intraMolecular", defaultValue = "false")
     ...
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name ="availabilityRef")
     ...
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name ="modelled", defaultValue = "false", type = Boolean.class)
     ...
     */
    @XmlElement(namespace = "net:sf:psidev:mi", name ="negative", defaultValue = "false", type = Boolean.class)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name = "participantEvidenceWrapper")
    public static class JAXBParticipantWrapper extends AbstractPsiXmlInteraction.JAXBParticipantWrapper<ParticipantEvidence> {
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type = XmlParticipantEvidence.class, name = "participant", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name = "experimentalConfidenceWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name = "experimentalParameterWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name = "experimentListType")
