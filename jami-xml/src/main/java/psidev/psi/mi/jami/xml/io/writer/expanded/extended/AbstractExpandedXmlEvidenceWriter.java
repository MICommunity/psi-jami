 ...
 */
public abstract class AbstractExpandedXmlEvidenceWriter extends AbstractExpandedXmlWriter<InteractionEvidence> {

    /**
     * <p>Constructor for ExpandedXmlEvidenceWriter.</p>
     */
    public AbstractExpandedXmlEvidenceWriter() {
     ...
     */
    public AbstractExpandedXmlEvidenceWriter(File file) throws IOException, XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractExpandedXmlEvidenceWriter(OutputStream output) throws XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractExpandedXmlEvidenceWriter(Writer writer) throws XMLStreamException {
     ...
     */
    public AbstractExpandedXmlEvidenceWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
