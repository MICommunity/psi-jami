 ...
 */
public abstract class AbstractParticipantRef<I extends Interaction, T extends Feature> extends AbstractEntityRef<T> implements ExtendedPsiXmlEntity<T>, psidev.psi.mi.jami.model.NamedParticipant<I, T> {
