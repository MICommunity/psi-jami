...
public class ModelledEntry extends AbstractEntry<ModelledInteraction> {
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.xml254.ModelledEntry.JAXBExperimentsWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.xml254.ModelledEntry.JAXBInteractionsWrapper} object.
     */
    ...
    //////////////////////////////// class wrapper
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="modelledExperimentsWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="basicInteractionsWrapper")
    public static class JAXBInteractionsWrapper extends AbstractEntry.JAXBInteractionsWrapper<ModelledInteraction>{
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= DefaultXmlModelledInteraction.class, name="interaction", required = true)
