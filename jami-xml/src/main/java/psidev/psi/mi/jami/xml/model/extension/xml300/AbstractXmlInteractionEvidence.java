...
import psidev.psi.mi.jami.xml.model.reference.xml300.AbstractAvailabilityRef;
...
public abstract class AbstractXmlInteractionEvidence extends AbstractPsiXmlInteraction<ParticipantEvidence> implements ExtendedPsiXmlInteractionEvidence {
     ...
     */
    @Override
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="inferredInteractionList")
     ...
     */
    @Override
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="interactionType", type = XmlCvTerm.class)
    ...
    public void setAvailability(String availability) {
        if (this.availability == null && availability != null) {
            this.availability = new DefaultAvailability();
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="intraMolecular", defaultValue = "false")
     ...
     *
     * @param jaxbParticipantWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlInteractionEvidence.JAXBParticipantWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlInteractionEvidence.JAXBConfidenceWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlInteractionEvidence.JAXBParameterWrapper} object.
     */
     ...
     *
     * @param value allowed object is {@link psidev.psi.mi.jami.xml.model.extension.xml300.DefaultAvailability}
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="availability")
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="availabilityRef")
     ...
     *
     * @param value allowed object is {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlInteractionEvidence.JAXBExperimentWrapper}
     */
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="modelled", defaultValue = "false", type = Boolean.class)
     ...
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="negative", defaultValue = "false", type = Boolean.class)
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlInteractionEvidence.JAXBConfidenceWrapper} object.
     */
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlInteractionEvidence.JAXBParameterWrapper} object.
     */
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml300.AbstractXmlInteractionEvidence.JAXBExperimentWrapper} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name = "participantEvidenceWrapper")
    public static class JAXBParticipantWrapper extends AbstractPsiXmlInteraction.JAXBParticipantWrapper<ParticipantEvidence> {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", type = XmlParticipantEvidence.class, name = "participant", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name = "experimentalConfidenceWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif300", name = "experimentalParameterWrapper")
    ...
    public static class JAXBExperimentWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif300", name ="experimentDescription", required = true, type = DefaultXmlExperiment.class)
