...
import psidev.psi.mi.jami.xml.model.reference.xml254.AbstractInteractorRef;
...
public class ExperimentalInteractor extends AbstractExperimentalInteractor {
    ...
    public void setJAXBInteractor(DefaultXmlInteractor value) {
        super.setJAXBInteractor(value, PsiXmlVersion.v2_5_4);
    }
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.ExperimentalInteractor.JAXBExperimentRefWrapper} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name = "interactorExperimentRefList")
