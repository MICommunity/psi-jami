...
public class XmlParticipantEvidence extends AbstractXmlParticipant<InteractionEvidence, FeatureEvidence> implements
    ...
    ////////////////////////////////////////////////////// classes
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceFeatureWrapper")
    public static class JAXBFeatureWrapper extends AbstractXmlParticipant.JAXBFeatureWrapper<FeatureEvidence> {
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type=XmlFeatureEvidence.class, name="feature", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceIdentificationWrapper")
    public static class JAXBParticipantIdentificationWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type=ExperimentalCvTerm.class, name="participantIdentificationMethod", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidencePreparationWrapper")
    public static class JAXBExperimentalPreparationWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type=ExperimentalCvTerm.class, name="experimentalPreparation", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceRoleWrapper")
    public static class JAXBExperimentalRoleWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type=ExperimentalCvTerm.class, name="experimentalRole", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceInteractorWrapper")
    public static class JAXBExperimentalInteractorWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type=ExperimentalInteractor.class, name="experimentalInteractor", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceOrganismWrapper")
    public static class JAXBHostOrganismWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type= HostOrganism.class, name="hostOrganism", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceConfidenceWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceParameterWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="participantEvidenceInteractorCandidateWrapper")
    public static class JAXBInteractorCandidatesWrapper extends
        ...
        @Override
        @XmlElement(namespace = "net:sf:psidev:mi", name ="interactorCandidate", type = XmlExperimentalParticipantCandidate.class)
