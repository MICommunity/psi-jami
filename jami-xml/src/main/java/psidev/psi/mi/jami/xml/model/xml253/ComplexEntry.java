...
public class ComplexEntry extends AbstractEntry<Complex> {
    ...
    //////////////////////////////// class wrapper
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="complexExperimentsWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="complexInteractionsWrapper")
    public static class JAXBInteractionsWrapper extends AbstractEntry.JAXBInteractionsWrapper<Complex>{
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", type= DefaultXmlComplex.class, name="interaction", required = true)
