...
public class HostOrganism extends XmlOrganism {
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml253.HostOrganism.JAXBExperimentRefWrapper} object.
     */
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name = "hostOrganismExperimentRefList")
