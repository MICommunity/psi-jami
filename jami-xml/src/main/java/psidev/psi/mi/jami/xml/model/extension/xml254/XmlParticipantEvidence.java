...
public class XmlParticipantEvidence extends AbstractXmlParticipant<InteractionEvidence, FeatureEvidence> implements
     ...
     *
     * @param jaxbFeatureWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBFeatureWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBParticipantIdentificationWrapper} object.
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="participantIdentificationMethodList")
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBExperimentalRoleWrapper} object.
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="experimentalRoleList")
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBExperimentalPreparationWrapper} object.
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="experimentalPreparationList")
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBExperimentalInteractorWrapper} object.
     */
    @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="experimentalInteractorList")
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBHostOrganismWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBParameterWrapper} object.
     */
     ...
     *
     * @param wrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBConfidenceWrapper} object.
     */
     ...
     *
     * @param pool a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlParticipantEvidence.JAXBInteractorCandidatesWrapper} object.
     */
    ...
    ////////////////////////////////////////////////////// classes
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceFeatureWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceIdentificationWrapper")
    public static class JAXBParticipantIdentificationWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= ExperimentalCvTerm.class, name="participantIdentificationMethod", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidencePreparationWrapper")
    public static class JAXBExperimentalPreparationWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= ExperimentalCvTerm.class, name="experimentalPreparation", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceRoleWrapper")
    public static class JAXBExperimentalRoleWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= ExperimentalCvTerm.class, name="experimentalRole", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceInteractorWrapper")
    public static class JAXBExperimentalInteractorWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= ExperimentalInteractor.class, name="experimentalInteractor", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceOrganismWrapper")
    public static class JAXBHostOrganismWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= HostOrganism.class, name="hostOrganism", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceConfidenceWrapper")
    public static class JAXBConfidenceWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= XmlConfidence.class, name="confidence", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceParameterWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="participantEvidenceInteractorCandidateWrapper")
    public static class JAXBInteractorCandidatesWrapper extends
        ...
        @Override
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name ="interactorCandidate", type = XmlExperimentalParticipantCandidate.class)
