 ...
 */
@XmlTransient
public class XmlModelledInteractionComplexWrapper implements Complex, FileSourceContext, psidev.psi.mi.jami.xml.model.extension.ExtendedPsiXmlModelledInteraction {

    private psidev.psi.mi.jami.xml.model.extension.ExtendedPsiXmlModelledInteraction modelledInteraction;
     ...
     */
    public XmlModelledInteractionComplexWrapper(psidev.psi.mi.jami.xml.model.extension.ExtendedPsiXmlModelledInteraction modelled){
        if (modelled == null){
    ...
    public void setPhysicalProperties(String properties) {
        ...
        if (propertiesAnnot != null){
            ...
            this.modelledInteraction.getAnnotations().add(new DefaultXmlAnnotation(CvTermUtils.createMICvTerm(Annotation.COMPLEX_PROPERTIES, Annotation.COMPLEX_PROPERTIES_MI), properties));
        }
    }
