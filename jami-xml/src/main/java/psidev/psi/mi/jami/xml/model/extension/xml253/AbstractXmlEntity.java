...
public abstract class AbstractXmlEntity<F extends Feature> implements ExtendedPsiXmlEntity<F>, FileSourceContext, Locatable{
    ...
    public void setJAXBInteractor(DefaultXmlInteractor interactor) {
        if (interactor == null){
            ...
            this.interactor = this.interactorFactory.createInteractorFromXmlInteractorInstance(interactor, PsiXmlVersion.v2_5_3);
        }
    }
    ...
    @XmlType(namespace = "net:sf:psidev:mi", name="featureWrapper")
