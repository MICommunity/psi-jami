package psidev.psi.mi.jami.xml.io.writer.elements.impl.abstracts.xml25.xml254;
...
public abstract class AbstractXmlModelledInteractionWriter<I extends ModelledInteraction>
    ...
    protected void initialiseDefaultExperiment() {
        Experiment defaultExperiment = new DefaultXmlExperiment(new BibRef("Mock publication and experiment for abstract interactions that are not interaction evidences.",(String)null,(Date)null));
        ...
        if (!interaction.getCooperativeEffects().isEmpty()){
            ...
            if (!effect.getCooperativityEvidences().isEmpty()){
                ...
                if (evidence.getPublication() != null){
                    exp = new DefaultXmlExperiment(evidence.getPublication());
                    ((DefaultXmlExperiment)exp).setFullName(evidence.getPublication().getTitle());
                }
            }
        }
     ...
     * @param nameAc a {@link String} object.
    ...
    protected CvTerm writeExperiments(I object) throws XMLStreamException {
        ...
        if (!object.getCooperativeEffects().isEmpty()){
            ...
            if (!effect.getCooperativityEvidences().isEmpty()){
                ...
                // set first experiment as default experiment
                if (evidence.getPublication() != null){
                    NamedExperiment exp = new DefaultXmlExperiment(evidence.getPublication());
