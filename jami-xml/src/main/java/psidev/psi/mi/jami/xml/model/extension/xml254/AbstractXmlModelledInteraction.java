...
public abstract class AbstractXmlModelledInteraction extends AbstractPsiXmlInteraction<ModelledParticipant> implements ExtendedPsiXmlModelledInteraction {
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="modelledParticipantWrapper")
    public static class JAXBParticipantWrapper extends AbstractPsiXmlInteraction.JAXBParticipantWrapper<ModelledParticipant> {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= XmlModelledParticipant.class, name="participant", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="modelledConfidenceWrapper")
    public static class JAXBConfidenceWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= XmlModelledConfidence.class, name="confidence", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="modelledParameterWrapper")
    public static class JAXBParameterWrapper implements Locatable, FileSourceContext {
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", type= XmlModelledParameter.class, name="parameter", required = true)
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name = "modelledExperimentListType")
