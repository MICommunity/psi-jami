...
import psidev.psi.mi.jami.xml.model.reference.xml253.AbstractComplexRef;
...
public abstract class AbstractXmlParticipant<I extends Interaction, F extends Feature> extends AbstractXmlEntity<F>
     ...
     * @param value
     *     allowed object is
     *     {@link psidev.psi.mi.jami.xml.model.extension.xml253.XrefContainer}
     */
     ...
     *
     * @param stoichiometry a {@link psidev.psi.mi.jami.xml.model.extension.XmlStoichiometry} object.
     */
     ...
     *
     * @param stoichiometry a {@link psidev.psi.mi.jami.xml.model.extension.xml253.XmlStoichiometryRange} object.
     */
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml253.AbstractXmlParticipantPool} object.
     */
     ...
     *
     * @param jaxbAttributeWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml253.AbstractXmlParticipant.JAXBAttributeWrapper} object.
     */
    ...
    @XmlType(namespace = "net:sf:psidev:mi", name="entityAttributeWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "net:sf:psidev:mi", name="interactorCandidateListWrapper")
    public static class JAXBInteractorCandidateWrapper<I extends Interaction,F extends Feature,P extends ParticipantCandidate>
        ...
        @XmlElement(namespace = "net:sf:psidev:mi", name="moleculeSetType", required = true)
