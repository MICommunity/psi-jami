...
public abstract class AbstractXmlParticipant<I extends Interaction, F extends Feature> extends AbstractXmlEntity<F>
     ...
     *
     * @param stoichiometry a {@link psidev.psi.mi.jami.xml.model.extension.xml254.XmlStoichiometryRange} object.
     */
     ...
     *
     * @return a {@link psidev.psi.mi.jami.xml.model.extension.xml254.AbstractXmlParticipantPool} object.
     */
     ...
     *
     * @param jaxbAttributeWrapper a {@link psidev.psi.mi.jami.xml.model.extension.xml254.AbstractXmlParticipant.JAXBAttributeWrapper} object.
     */
    ...
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="entityAttributeWrapper")
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    @XmlType(namespace = "http://psi.hupo.org/mi/mif", name="interactorCandidateListWrapper")
    public static class JAXBInteractorCandidateWrapper<I extends Interaction,F extends Feature,P extends ParticipantCandidate>
        ...
        @XmlElement(namespace = "http://psi.hupo.org/mi/mif", name="moleculeSetType", required = true)
