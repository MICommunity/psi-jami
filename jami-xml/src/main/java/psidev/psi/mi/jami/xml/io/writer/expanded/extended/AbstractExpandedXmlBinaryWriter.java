 ...
 */
public abstract class AbstractExpandedXmlBinaryWriter extends AbstractExpandedXmlMixWriter<BinaryInteraction, ModelledBinaryInteraction, BinaryInteractionEvidence> {

    /**
     * <p>Constructor for ExpandedXmlBinaryWriter.</p>
     */
    public AbstractExpandedXmlBinaryWriter() {
     ...
     */
    public AbstractExpandedXmlBinaryWriter(File file) throws IOException, XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractExpandedXmlBinaryWriter(OutputStream output) throws XMLStreamException {
     ...
     * @throws javax.xml.stream.XMLStreamException if any.
     */
    public AbstractExpandedXmlBinaryWriter(Writer writer) throws XMLStreamException {
