...
import psidev.psi.mi.jami.tab.io.writer.extended.Mitab28EvidenceWriter;
...
/**
 * Unit tester for Mitab28EvidenceWriter
 *
...
public class Mitab28EvidenceWriterTest {

    @Test
    public void test_mitab_version_and_header(){
        Mitab28EvidenceWriter binaryWriter = new Mitab28EvidenceWriter();
    ...
    public void test_write_binary() throws ParseException, IllegalParameterException {
        ...
        Mitab28EvidenceWriter binaryWriter = new Mitab28EvidenceWriter(writer);
