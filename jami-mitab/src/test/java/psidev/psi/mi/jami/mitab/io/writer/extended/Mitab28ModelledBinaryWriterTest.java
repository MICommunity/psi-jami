...
import psidev.psi.mi.jami.tab.io.writer.extended.Mitab28ModelledBinaryWriter;
...
/**
 * Unit tester for Mitab28ModelledBinaryWriter
 *
...
public class Mitab28ModelledBinaryWriterTest {

    @Test
    public void test_mitab_version_and_header(){
        Mitab28ModelledBinaryWriter binaryWriter = new Mitab28ModelledBinaryWriter();
    ...
    public void test_write_binary() throws IllegalParameterException, ParseException {
        ...
        Mitab28ModelledBinaryWriter binaryWriter = new Mitab28ModelledBinaryWriter(writer);
