...
import psidev.psi.mi.jami.tab.io.writer.extended.Mitab28BinaryEvidenceWriter;
...
/**
 * Unit tester for Mitab28BinaryEvidenceWriter
 *
...
public class Mitab28BinaryEvidenceWriterTest {

    @Test
    public void test_mitab_version_and_header(){
        Mitab28BinaryEvidenceWriter binaryWriter = new Mitab28BinaryEvidenceWriter();
    ...
    public void test_write_binary() throws ParseException, IllegalParameterException {
        ...
        Mitab28BinaryEvidenceWriter binaryWriter = new Mitab28BinaryEvidenceWriter(writer);
