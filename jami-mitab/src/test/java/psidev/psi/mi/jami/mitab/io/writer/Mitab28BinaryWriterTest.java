...
import psidev.psi.mi.jami.tab.io.writer.Mitab28BinaryWriter;
...
/**
 * Unit tester for Mitab28BinaryWriter
 *
...
public class Mitab28BinaryWriterTest {

    @Test
    public void test_mitab_version_and_header(){
        Mitab28BinaryWriter binaryWriter = new Mitab28BinaryWriter();
    ...
    public void test_write_binary() throws IllegalParameterException, ParseException {
        ...
        Mitab28BinaryWriter binaryWriter = new Mitab28BinaryWriter(writer);
        binaryWriter.setWriteHeader(false);

        ModelledBinaryInteraction modelledBinaryInteraction = createModelledBinaryInteraction();

        binaryWriter.write(modelledBinaryInteraction);

        String expectedModelledMitabLine = getExpectedModelledMitabLine();
        Assert.assertEquals(expectedModelledMitabLine, writer.toString());
    }
    ...
    public void test_write_binary_list() throws ParseException, IllegalParameterException {
        ...
        ModelledBinaryInteraction modelledBinaryInteraction = createModelledBinaryInteraction();
        BinaryInteractionEvidence binaryInteractionEvidence = createBinaryInteractionEvidence();

        binaryWriter.write(Arrays.asList((BinaryInteraction) modelledBinaryInteraction, (BinaryInteraction) binaryInteractionEvidence));

        String expectedModelledMitabLine = getExpectedModelledMitabLine();
        String expectedexpectedInteractionEvidenceMitabLineline2 = getExpectedInteractionEvidenceMitabLine();
        Assert.assertEquals(expectedModelledMitabLine+ MitabUtils.LINE_BREAK+expectedexpectedInteractionEvidenceMitabLineline2, writer.toString());
    }
    ...
    public void test_write_binary2() throws ParseException, IllegalParameterException {
        ...
        BinaryInteractionEvidence binaryInteractionEvidence = createBinaryInteractionEvidence();
        String expectedInteractionEvidenceMitabLine = getExpectedInteractionEvidenceMitabLine();

        binaryWriter.write(binaryInteractionEvidence);

        Assert.assertEquals(expectedInteractionEvidenceMitabLine, writer.toString());
    }

    private String getExpectedModelledMitabLine() {
    ...
    private String getExpectedInteractionEvidenceMitabLine() {
        return "uniprotkb:P12345" +
                "\tuniprotkb:P12347" +
                "\tuniprotkb:P12346|intact:EBI-12345" +
                "\tuniprotkb:P12348|intact:EBI-12346" +
    ...
    private BinaryInteractionEvidence createBinaryInteractionEvidence() throws ParseException, IllegalParameterException {
        ...
        // biological effect
        binary.getParticipantA().setBiologicalEffect(CvTermUtils.createGOCvTerm("kinase activity","GO:0016301"));
        binary.getParticipantB().setBiologicalEffect(CvTermUtils.createGOCvTerm("kinase activity","GO:0016301"));

        // causal statement
        binary.getParticipantA().getCausalRelationships().add(new MitabCausalRelationship(CvTermUtils.createMICvTerm("up regulates","MI:2235"), participantB));

        // causal regulatory mechanism
        binary.setCausalRegulatoryMechanism(CvTermUtils.createMICvTerm("post transcriptional regulation","MI:2249"));
