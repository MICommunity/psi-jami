...
import psidev.psi.mi.jami.tab.io.writer.extended.Mitab28ModelledWriter;
...
/**
 * Unit tester for Mitab28ModelledWriter
 *
...
public class Mitab28ModelledWriterTest {

    @Test
    public void test_mitab_version_and_header(){
        Mitab28ModelledWriter binaryWriter = new Mitab28ModelledWriter();
    ...
    public void test_write_interaction() throws IllegalParameterException, ParseException {
        ...
        Mitab28ModelledWriter interactionWriter = new Mitab28ModelledWriter(writer);
    ...
    public void test_write_binary_list() throws IllegalParameterException, ParseException {
        StringWriter writer = new StringWriter();
        Mitab28ModelledWriter binaryWriter = new Mitab28ModelledWriter(writer);
