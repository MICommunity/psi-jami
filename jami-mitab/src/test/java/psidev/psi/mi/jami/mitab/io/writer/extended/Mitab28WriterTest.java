...
import psidev.psi.mi.jami.tab.io.writer.extended.Mitab28Writer;
...
public class Mitab28WriterTest {

    @Test
    public void test_mitab_version_and_header(){
        Mitab28Writer binaryWriter = new Mitab28Writer();
    ...
    public void test_write_binary() throws IllegalParameterException, ParseException {
        ...
        Mitab28Writer binaryWriter = new Mitab28Writer(writer);
