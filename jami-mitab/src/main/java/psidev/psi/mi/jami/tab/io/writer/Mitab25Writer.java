...
public class Mitab25Writer extends AbstractMitabWriter<Interaction, BinaryInteraction, Participant> {
     ...
     *
     * @param modelledInteractionWriter a {@link psidev.psi.mi.jami.tab.io.writer.Mitab25ModelledWriter} object.
     */
     ...
     *
     * @param interactionEvidenceWriter a {@link psidev.psi.mi.jami.tab.io.writer.Mitab25EvidenceWriter} object.
     */
