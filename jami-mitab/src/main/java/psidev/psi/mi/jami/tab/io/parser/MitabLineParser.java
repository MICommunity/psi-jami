...
public abstract class MitabLineParser<T extends Interaction, P extends Participant, F extends Feature> implements MitabLineParserConstants {
    ...
    final public Collection<MitabCvTerm> cvTerms(int columnNumber) throws ParseException {
        ...
        methods = new ArrayList<MitabCvTerm>();
        if (var != null) {
            methods.add(var);
        }
        label_3:
    ...
    final public Collection<MitabAuthor> firstAuthors() throws ParseException {
        ...
        MitabAuthor var;
        var = author();
        authors = new ArrayList<MitabAuthor>();
        if (var != null) {
            authors.add(var);
        }
        label_4:
    ...
    final public Collection<MitabOrganism> taxId(int column) throws ParseException {
        ...
        MitabOrganism var;
        var = organism(column);
        organisms = new ArrayList<MitabOrganism>();
        if (var != null) {
            organisms.add(var);
        }
        label_5:
    ...
    final public Collection<MitabSource> sourceDbs() throws ParseException {
        ...
        MitabSource var;
        var = source();
        sources = new ArrayList<MitabSource>();
        if (var != null) {
            sources.add(var);
        }
        label_6:
    ...
    final public Collection<MitabConfidence> confidences() throws ParseException {
        ...
        MitabConfidence var;
        var = confidence();
        confs = new ArrayList<MitabConfidence>();
        if (var != null) {
            confs.add(var);
        }
        label_7:
    ...
    final public Collection<MitabCvTerm> complexExpansion() throws ParseException {
        ...
        MitabCvTerm var;
        var = expansion();
        expansions = new ArrayList<MitabCvTerm>();
        if (var != null) {
            expansions.add(var);
        }
        label_8:
    ...
    final public Collection<MitabAnnotation> annotations(int column) throws ParseException {
        ...
        annots = new ArrayList<MitabAnnotation>();
        if (var != null) {
            annots.add(var);
        }
        label_9:
    ...
    final public Collection<MitabParameter> parameters() throws ParseException {
        ...
        MitabParameter var;
        var = parameter();
        params = new ArrayList<MitabParameter>();
        if (var != null) {
            params.add(var);
        }
        label_10:
    ...
    final public Collection<MitabStoichiometry> stoichiometryList(int column) throws ParseException {
        ...
        stc = new ArrayList<MitabStoichiometry>();
        if (var != null) {
            stc.add(var);
        }
        label_14:
        ...
        try {
            ...
            try {
                ...
                if (getParserListener() != null) {
                    getParserListener().onInvalidStoichiometry(e.getMessage(), new DefaultFileSourceContext(new MitabSourceLocator(beginLine, beginColumn, columnNumber)));
                }
            }
            if (maxString != null) {
                try {
                ...
                try {
                    ...
                    if (getParserListener() != null) {
                        getParserListener().onInvalidStoichiometry(e.getMessage(), stc);
                    }
                }
            } else {
    ...
    final public MitabRange range(int columnNumber) throws ParseException {
        ...
        try {
            ...
            try {
                ...
                if (getParserListener() != null) {
                    getParserListener().onInvalidPosition(e.getMessage(), new DefaultFileSourceContext(new MitabSourceLocator(beginLine, beginColumn, columnNumber)));
                }
            } catch (IllegalArgumentException e) {
                start = PositionUtils.createUndeterminedPosition();
                if (getParserListener() != null) {
            ...
            try {
                ...
                range.setSourceLocator(new MitabSourceLocator(beginLine, beginColumn, columnNumber));
                if (getParserListener() != null) {
                    getParserListener().onInvalidRange(e.getMessage(), range);
                }
            }
            {
    ...
    final public MitabChecksum checksum(int columnNumber) throws ParseException {
        ...
        try {
            ...
            if (method == null && getParserListener() != null) {
                getParserListener().onMissingChecksumMethod(checksum);
            }
            if (value == null && getParserListener() != null) {
                getParserListener().onMissingChecksumValue(checksum);
            }
            {
    ...
    final public MitabParameter parameter() throws ParseException {
        ...
        try {
            ...
            if (type == null && getParserListener() != null) {
                getParserListener().onMissingParameterType(param);
            }
            if (value == null && getParserListener() != null) {
                getParserListener().onMissingParameterValue(param);
            }
            {
    ...
    final public MitabAnnotation annotation(int columnNumber) throws ParseException {
        ...
        try {
            ...
            if (topic == null && getParserListener() != null) {
                getParserListener().onAnnotationWithoutTopic(annot);
            }
            {
    ...
    final public MitabCvTerm expansion() throws ParseException {
        ...
        try {
            ...
            if (id == null) {
                cv = new MitabCvTerm(name);
                cv.setSourceLocator(new MitabSourceLocator(beginLine, beginColumn, 16));
                if (getParserListener() != null) {
                    getParserListener().onMissingExpansionId(cv);
                }
            } else {
                cv = new MitabCvTerm(name, null, db, id);
                cv.setSourceLocator(new MitabSourceLocator(beginLine, beginColumn, 16));
            }
            if (name == null && getParserListener() != null) {
                getParserListener().onMissingCvTermName(cv, cv, "The expansion method at the column 16 does not have a name.");
            }
            {
                if (true) return cv;
            }
    ...
    final public MitabConfidence confidence() throws ParseException {
        ...
        try {
            ...
            if (text == null) {
                conf = new MitabConfidence(type, value, null);
                conf.setSourceLocator(new MitabSourceLocator(beginLine, beginColumn, 15));
            } else {
                conf = new MitabConfidence(type, value, text);
                conf.setSourceLocator(new MitabSourceLocator(beginLine, beginColumn, 15));
                if (getParserListener() != null) {
            ...
            if (type == null && getParserListener() != null) {
                getParserListener().onMissingConfidenceType(conf);
            }
            if (value == null && getParserListener() != null) {
                getParserListener().onMissingConfidenceValue(conf);
            }
            {
                if (true) return conf;
            }
    ...
    final public MitabSource source() throws ParseException {
        ...
        try {
            ...
            s = new MitabSource(name, null, db, id);
            s.setSourceLocator(new MitabSourceLocator(beginLine, beginColumn, 13));
            if (name == null && getParserListener() != null) {
                getParserListener().onMissingCvTermName(s, s, "The source at the column 13 does not have a name.");
            }
            {
                if (true) return s;
            }
    ...
    final public MitabOrganism organism(int columnNumber) throws ParseException {
        ...
        try {
            ...
            if (!db.equalsIgnoreCase("taxid")) {
                ...
                error_skipToNext(enumSet, false);
                {
                    if (true) return null;
                }
            }
            ...
            try {
                ...
                if ((tax == 0 || tax < -5) && getParserListener() != null) {
                    getParserListener().onInvalidOrganismTaxid(id, organism);
                }
                {
    ...
    final public MitabAlias alias(int columnNumber) throws ParseException {
        ...
        try {
            ...
            if (db == null && getParserListener() != null) {
                getParserListener().onAliasWithoutDbSource(alias);
            }
            if (name == null && getParserListener() != null) {
                getParserListener().onAliasWithoutName(alias);
            }
            {
    ...
    final public MitabXref id(CvTerm qualifier, boolean recognizeImexPrimary, int columnNumber) throws ParseException {
        ...
        try {
            ...
            if (recognizeImexPrimary && Xref.IMEX.equalsIgnoreCase(db.trim())) {
                if (text == null) {
                    ref = new MitabXref(db, id, CvTermUtils.getImexPrimary());
            ...
            if (db == null && getParserListener() != null) {
                getParserListener().onXrefWithoutDatabase(ref);
            }
            if (id == null && getParserListener() != null) {
                getParserListener().onXrefWithoutId(ref);
            }
            {
                if (true) return ref;
            }
     ...
     *
     * @return a {link @ParseException} object.
     */
